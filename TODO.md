...
- [ ] Pipeline for extraction of textbooks and the regex/images associated with it
- [ ] New chunking strategies needed for textbooks
- [ ] Verification of information from textbooks
- [ ] Identification of title strings by cross checking anna archive
- [ ] Keeping a dictionary from anna archive to identify documents so the pipeline knows what process to process future files