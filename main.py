...
async def async_main():
    parser = argparse.ArgumentParser(
        description="Enterprise Document Ingestion Pipeline for RAG")
    parser.add_argument(
        "--action",
        type=str,
    ...
    if args.action == "extract":
        console.print(
            f"[bold blue]Starting Extraction Pipeline[/bold blue] (Config: {args.config})")
        ...
        console.print(
            f"[bold blue]Starting Indexing Pipeline[/bold blue] (Config: {args.config})")
